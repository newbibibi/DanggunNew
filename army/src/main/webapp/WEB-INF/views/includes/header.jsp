              ...
              <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav mr-auto">
                      ...
                      <li class="nav-item"><a class="nav-link" href="/center/notice/noticeList">Notice</a></li>
                      ...
                      <li class="nav-item"><a class="nav-link" href="/board/boardList">Community</a></li>
              
                      <li class="nav-item dropdown">
                          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Customer Service <i class="fa fa-angle-down"></i></a>
                          <ul class="dropdown-menu" role="menu">
                      ...
                      <li class="nav-item dropdown">
                          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">User <i class="fa fa-angle-down"></i></a>
                          <ul class="dropdown-menu" role="menu">
