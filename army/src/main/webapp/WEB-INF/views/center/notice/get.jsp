...
<div class="container">
	...
	<button class="btn btn-primary" type="button" style=" float: right;"><a href="/center/notice/modify?nno=${vo.nno }">수정</a></button>
	</c:if>
	...
	<div>
		...
		<form id="actionForm" action="/center/notice/get" name="test"
			method="get">
